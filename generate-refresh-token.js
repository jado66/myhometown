...
const CLIENT_ID =
  process.env.CS_GMAIL_CLIENT_ID || process.env.MHT_GMAIL_CLIENT_ID;
const CLIENT_SECRET =
  process.env.CS_GMAIL_CLIENT_SECRET || process.env.MHT_GMAIL_CLIENT_SECRET;
...
if (!CLIENT_ID || !CLIENT_SECRET) {
  ...
  console.error(
    "Make sure your .env.local file has CS_GMAIL_CLIENT_ID and CS_GMAIL_CLIENT_SECRET",
  );
  process.exit(1);
}
...
async function generateRefreshToken() {
  ...
  console.log(
    "        blank page. Copy the ENTIRE URL from your browser's address bar.",
  );
  console.log(
    "        It will look like: http://localhost?code=XXXXXXX&scope=...",
  );
  console.log("\n");
