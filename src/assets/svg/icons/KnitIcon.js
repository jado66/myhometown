...
const KnitIcon = ({ fillColor = "#318d43", sx }) => (
  <SvgIcon viewBox="0 0 360 360" sx={{ ...sx }}>
    ...
    <path
      className="knit-c"
      d="M205,170.8c-.7,0-1.4-.1-2.1-.4-7.7-2.7-14.3-7.5-19.2-14-1.6-2.2-1.7-5.1-.3-7.4,2.9-4.5,5.5-9.3,7.9-14.1,1.1-2.2,3.3-3.6,5.8-3.6h0c2.5,0,4.7,1.4,5.8,3.6,4.5,9,7.4,18.7,8.6,28.7.3,2.2-.6,4.4-2.4,5.8-1.2.9-2.6,1.4-4.1,1.4Z"
    />
    <path
      className="knit-c"
      d="M205,189.8c-.5,0-.9,0-1.4-.2-11.7-2.6-22.2-8.5-30.4-17.3-2.2-2.4-2.3-6-.3-8.5,3.8-4.7,7.3-9.6,10.5-14.7,1.1-1.8,3.1-2.9,5.2-3,2.1,0,4.2.9,5.5,2.6,3.4,4.5,7.9,7.8,13.1,9.6,2.4.8,4,2.9,4.3,5.4.4,3.3.6,6.7.6,10s-.2,7-.6,10.4c-.2,1.8-1.2,3.5-2.7,4.5-1.1.8-2.4,1.2-3.8,1.2ZM186.7,167.2c3.7,3.1,7.9,5.7,12.4,7.5,0-.3,0-.7,0-1,0-1.6,0-3.2-.2-4.8-3.3-1.6-6.4-3.5-9.2-5.9-1,1.4-2,2.9-3.1,4.3Z"
    />
    <path
      className="knit-c"
