          ...
          <ul>
            <li>
              <Typography gutterBottom display='flex'>
                In the <strong style={{marginLeft:'0.5em', marginRight:'0.5em'}}>Send via</strong> row click on the <strong><Code  style={{marginLeft:'0.5em'}}/></strong>
              </Typography>
            </li>
          </ul>
          <img
      ...
      return (
        <>
          <ul>
            <li>
              <Typography gutterBottom display='flex'>
                Click <strong style={{marginLeft:'0.5em', marginRight:'0.5em'}}>Copy</strong>
              </Typography>
            </li>
            <li>
              <Typography gutterBottom display='flex'>
                Paste the value inside the new class form on the MyHometown site.
              </Typography>
            </li>
          </ul>
          <img
...
export function IframeHelpDialog({ open, handleClose}) {
  ...
  return (
    ...
    <DialogTitle textAlign='center'>How to Get the Embed HTML iFrame Link from a Google Form</DialogTitle>
    <DialogContent >
