...
export default function MissionaryLogin() {
  ...
  useEffect(() => {
    ...
    if (savedEmail) {
      const rootUrl = "";
      router.replace(
        rootUrl + `/admin-dashboard/hours-and-directory/${savedEmail}`,
      );
    }
  }, [router]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setTimeout(() => {
          router.push(
            rootUrl + `/admin-dashboard/hours-and-directory/${email}`,
          );
        }, 1000);
      } else {
        setSuccess(false);
            ...
            <CardContent sx={{ p: 4 }}>
              <Box sx={{ textAlign: "center", mb: 4 }}>
                ...
                <Typography variant="h6" color="text.secondary">
                  Enter your email address to record service hours and view the
                  directory.
                </Typography>
              </Box>
